...
let category_options = {
    series: [44, 55, 41, 17],
    labels: ['Quần áo', 'Tiền mặt', 'Thực phẩm', 'Công trình'],
    chart: {
        type: 'donut',
    },
...
let customer_options = {
    series: [{
        ...
        name: "Lượt ủng hộ hàng tháng",
        data: [20, 30, 10, 20, 16, 40, 20, 51, 10,23,47,89]
    }],
    colors: ['#6ab04c'],
    chart: {
        height: 350,
    ...
    xaxis: {
        categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep','Dec','Oc','Nov'],
    },
    legend: {
        position: 'top'
    }
